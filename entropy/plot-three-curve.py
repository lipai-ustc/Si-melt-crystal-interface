...
def plot_and_save_smoothed_energy(
   ...
   # ax.axvline( -3.39999999999947, color='r', ls='--', lw=1)
   # ax.axvline(  3.70000000000062, color='r', ls='--', lw=1)
    # y 轴刻度
...
def main():
    ...
    output_dir = os.path.join(base_dir, "entropy111")
    ...
    # 三个晶面的 csv 文件
    csv_files = {
       # "100": os.path.join(base_dir, "100", "entropy","plot","100.csv"),
        #"110": os.path.join(base_dir, "110", "entropy","plot", "110.csv"),
        "111": os.path.join(base_dir, "111", "entropy","plot", "111.csv"),
    }
