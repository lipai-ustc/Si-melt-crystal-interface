...
# === 参数配置 ===
input_file = r'E:\free_energy\all_new_pot\100\cal-result\merge.xyz'
output_file = r'E:\free_energy\all_new_pot\100\msd\msd2_output.xyz'
...
for i in range(n_frames):
    ...
    atoms_with_disp.new_array("displacement", disp_mag)
