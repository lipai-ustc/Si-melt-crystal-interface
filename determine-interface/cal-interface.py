...
def main():
    ...
    # ---- 第二步：后续帧在±3.1附近找最接近0.6的位置 ----
    delta = 1.3#100:1.3,110:1.9,111:3.1
    ...
    for frame in frames[1:]:
        ...
        # 三个采样位置
        candidate_positions = initial_interface_x + offsets
