...
def plot_and_save_smoothed_energy_with_std(
    ...
    # 均值曲线
    ax.plot(centers, mean_energy, color='C0', lw=2, alpha=0.9)
...
def main():
    ...
    csv_files = {
        "100": os.path.join(base_dir, "100", "enthalpy", "avg_std_smoothed_energy_relative_to_interface.csv"),
        "110": os.path.join(base_dir, "110", "enthalpy", "avg_std_smoothed_energy_relative_to_interface.csv"),
        "111": os.path.join(base_dir, "111", "enthalpy", "avg_std_smoothed_energy_relative_to_interface.csv"),
    }
    ...
    for face, csv_path in csv_files.items():
        ...
        output_plot = os.path.join(os.path.dirname(csv_path), f"{face}_smoothed_energy_plot.png")
